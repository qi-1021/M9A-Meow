...
|:------------------------- |:----------------------------------------------------------------------------------- |:---------------------------------------------------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------- |
| **M9A**                   | [MAA1999/M9A](https://github.com/MAA1999/M9A)                                       | Commit [`2c4a3ac`](https://github.com/MAA1999/M9A/commit/2c4a3ac6c7c6c008135912aba165d18c573602e1)<br>(Tag: `v4.9.0-28-gacce2d43`) | 业务资源仓库，提供 `interface.json`、Pipeline 流水线、图片模板、各渠道服资源及 Python Agent 业务逻辑                |
