...
|:------------------------- |:----------------------------------------------------------------------------------- |:---------------------------------------------------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------- |
| **M9A**                   | [MAA1999/M9A](https://github.com/MAA1999/M9A)                                       | Commit [`6cfe86a`](https://github.com/MAA1999/M9A/commit/6cfe86aa2bf8d0a5a087276d2d4254a342250c01)<br>(Tag: `v4.9.0-28-gacce2d43`) | 业务资源仓库，提供 `interface.json`、Pipeline 流水线、图片模板、各渠道服资源及 Python Agent 业务逻辑                |
